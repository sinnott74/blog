import{j as e}from"./jsx-runtime.521a1206.js";import{u as o}from"./index.f57d9ee7.js";import"./vendor.81a8656d.js";const p="Divide and Conquer",l="Daniel Sinnott",h="https://i.imgur.com/2Poehrs.png",d=21,x=["Technical","ExpressJS","NGINX","Microservices"],g="Mon, 9th Jul 2018",m=new Date(1531153042885);function u(n={}){const{wrapper:t}=Object.assign({},o(),n.components);return t?e.exports.jsx(t,Object.assign({},n,{children:e.exports.jsx(r,{})})):r();function r(){const s=Object.assign({h2:"h2",p:"p",a:"a",blockquote:"blockquote",img:"img",pre:"pre",code:"code",span:"span"},o(),n.components);return e.exports.jsxs(e.exports.Fragment,{children:[e.exports.jsx(s.h2,{children:"Monolith"}),`
...
`,e.exports.jsx(s.pre,{className:"language-nginx",children:e.exports.jsxs(s.code,{className:"language-nginx",children:[e.exports.jsxs(s.span,{className:"token directive",children:[e.exports.jsx(s.span,{className:"token keyword",children:"location"})," /api/"]})," ",e.exports.jsx(s.span,{className:"token punctuation",children:"{"}),`
    `,e.exports.jsxs(s.span,{className:"token directive",children:[e.exports.jsx(s.span,{className:"token keyword",children:"proxy_pass"})," <%= ENV[",e.exports.jsx(s.span,{className:"token string",children:'"BACKEND_ADDR"'}),"] %>"]}),e.exports.jsx(s.span,{className:"token punctuation",children:";"}),`
...
`,`
`,`
`,e.exports.jsx(s.img,{src:"https://i.imgur.com/tfnZv0n.png",alt:"Resource Timings",title:"Resource Timings"})]})}}export{l as author,m as created,g as date,u as default,d as id,h as imageurl,x as tags,p as title};
